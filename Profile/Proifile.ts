...
import { Colors, Utils } from "rainbowbot-types/Utils";
import ModuleManager from "rainbowbot-types/ModuleManager";
import Module from "rainbowbot-types/Modules/Module";
import { SlashCommandBuilder } from "@discordjs/builders";
import User from "rainbowbot-types/Structures/User";
...
export default class Profile extends Module{
    ...
    public async Init(){
        await this.Controller.bot.PushSlashCommands(this.SlashCommands, process.env.NODE_ENV === "development" ? process.env.MASTER_GUILD : "global");
    }
